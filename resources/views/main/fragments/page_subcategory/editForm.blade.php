<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('web.admin.page_subcategory.update.do') }}" class="form_ parent-load row" method="post">
            <input type="hidden" name="id" value="{{ $page_subcategory->id }}">

            <div class="col-md-12 mb-3">
                <label for="name" class="form-label">{{ __('Correo') }}</label>
                <input type="text" name="name" id="name" class="form-control"
                    value="{{ $page_subcategory->name }}">
            </div>
