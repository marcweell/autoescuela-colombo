...
<div class="card">
    ...
    <div class="card-body">
        <div class="row mb-2">
            <div class="col-sm-5">
                <a data-href="{{ route('web.app.page.add.index') }}" data-id="-1"
                    ...
                    @for ($i = 0, $n = 1; $i < count($page ?? []), ($item = @$page[$i]); $i++, $n++)
                        <tr>
                            ...
                            <td class="table-action">
                                <a data-href="{{ route('web.app.page.update.index') }}"
                                    data-id='{{ $item->id }}' class="btn btn-secondary btn-sm _link_"><i
                                        class="fa fa-edit"></i></a>
                                <a data-href="{{ route('web.app.page.remove.do') }}" data-id='{{ $item->id }}'
                                    class="btn btn-secondary btn-sm _link_ prompt" data-title="Eliminar page"><i
