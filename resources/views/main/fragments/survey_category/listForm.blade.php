<div class="card">
    ...
    <div class="card-body">
        <div class="row mb-2">
            <div class="col-sm-5">
                <a data-href="{{ route('web.app.settings.survey_category.add.index') }}" data-id="-1"
                    ...
                    @for ($i = 0, $n = 1; $i < count($survey_category ?? []), ($item = @$survey_category[$i]); $i++, $n++)
                        <tr>
                            ...
                            <td class="table-action">
                                ...
                                <a data-href="{{ route('web.app.settings.survey_category.update.index') }}"
                                    data-id='{{ $item->id }}' class="btn btn-primary _link_"><i
                                        class="fa fa-edit"></i></a>
                                <a data-href="{{ route('web.app.settings.survey_category.remove.do') }}"
