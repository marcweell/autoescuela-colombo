<div class="card">
    ...
    <div class="card-body">
        <div class="row mb-2">
            <div class="col-sm-5">
                <a data-href="{{ route('web.admin.mandala.donate.add.index') }}" data-id="-1" class="btn btn-secondary  mb-2 l14k"><i
                    ...
                    @for ($i = 0, $n = 1; $i < count($mandala_donate ?? []), ($item = @$mandala_donate[$i]); $i++, $n++)
                        <tr>
                            ...
                            <td class="table-action">
                                ...
                                <a data-href="{{ route('web.admin.mandala.donate.update.index') }}"
                                    data-id='{{ $item->id }}' class="btn btn-secondary  l14k"><i
                                        class="fa fa-edit"></i></a>
                                <a data-href="{{ route('web.admin.mandala.donate.remove.do') }}"
