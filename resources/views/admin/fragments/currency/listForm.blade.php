<div class="card">
    <div class="card-header">
        <div class="card-title"><h5>{!! __("Moedas") !!}<h5></div>
    </div>
    <div class="card-body">
        <div class="row mb-2">
            <div class="col-sm-5">
                <a data-href="{{ route('web.admin.settings.currency.add.index') }}" data-id="-1" class="btn btn-secondary  mb-2 l14k"><i
                        class="fa fa-plus-circle me-2"></i> {{ __('Adicionar Moeda') }}</a>
            </div>
            <div class="col-sm-7">
                        ...
                        <tr>
                            ...
                            <td class="table-action">
                                ...
                                <a data-href="{{ route('web.admin.settings.currency.remove.do') }}"
                                    ...
                                    data-title="Remover Moeda"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endfor
                </tbody>
