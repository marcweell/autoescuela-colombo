    ...
    <div class="card-body">
        ...
        <form action="{{ route('web.admin.page.add.do') }}" class="form_ parent-load row" method="post">
            ...
            <div class="col-lg-4 mb-3">
                ...
                <input type="text" id="icono" class="form-control iconpicker">
            </div>
            ...
            <div class="col-lg-4 mb-3">
                ...
                <input data-toggle="touchspin" type="text" value="0" id="precio">
            </div>
            <div class="col-lg-4 mb-3">
                <label class="form-label">Precio de promocion</label>
                <input data-toggle="touchspin" type="text" value="0" id="precio_promo">
            </div>
            <div class="col-lg-4 mb-3">
            ...
            <div class="col-lg-12 mb-3">
                ...
                <button type="button" class="btn btn-primary" onclick="addParagrafoContent();"><i
                            class="uil-plus" aria-hidden="true"></i></button>
            </div>
            <div id="addparagrafo"></div>
            <div class="col-lg-12 mb-3">
                <label for="pais" class="form-label">Subcategoria</label>
                <button type="button" class="btn btn-primary" onclick="addSubcategoriaContent();"><i
                            class="uil-plus" aria-hidden="true"></i></button>
            </div>
