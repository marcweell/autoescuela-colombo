                    ...
                    @for ($i = 0, $n = 1; $i < count($session_history ?? []), ($item = @$session_history[$i]); $i++, $n++)
                        <tr>
                                ...
                                <div class="d-flex">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-shrink-0">
                                            <img src='{{ tools()->photo($item->user_profile_picture) }}' class="rounded-circle avatar-xs"
                                                alt="friend">
                                        </div>
                            ...
                            <td class="table-action">
                                ...
                                <a data-href="{{ route('web.admin.auditory.session_history.remove.do') }}" data-id='{{ $item->id }}' class="btn btn-secondary  l14k prompt" data-title="Remover"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endfor
                </tbody>
