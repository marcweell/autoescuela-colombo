<div class="card">
    ...
    <div class="card-body">
        ...
        <form action="{{ route('web.admin.settings.geo.country.update.do') }}" class="form_ parent-load row" method="post">
            <input type="hidden" name="id" value="{{ $country->id }}">
            <div class="col-md-6 mb-3">
                <label for="name" class="form-label">{{ __('Nombre') }}</label>
                <input type="text" name="name" required id="name" class="form-control" value="{{  $country->name }}">
            </div>
            <div class="col-md-6 mb-3">
