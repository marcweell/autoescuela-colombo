<div class="card">
    ...
    <div class="card-body">
        <h4 class="header-title">{{ __('Cadastro de Plano') }}</h4>

        <form action="{{ route('web.admin.settings.plan.add.do') }}" class="form_ parent-load row" method="post">
            ...
            <div class="col-12 mb-3">
                ...
                <input autocomplete="false" autofill="false" type="text" id="hex_color" class="form-control" value="">
            </div>
