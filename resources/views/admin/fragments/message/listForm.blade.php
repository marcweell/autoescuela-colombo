<div class="card">
    <div class="card-body">
        <div class="row mb-2">
            <div class="col-sm-5"> 
                <a data-href="{{ route('web.admin.message.compose.index') }}" data-id="-1" class="btn btn-secondary mb-2 l14k"><i
                    ...
                    @for ($i = 0, $n = 1; $i < count($message ?? []), ($item = @$message[$i]); $i++, $n++)
                        <tr>
                            ...
                            <td class="table-action">
                                <a data-href="{{ route('web.admin.message.reply.index') }}"
                                    data-id='{{ $item->id }}' class="btn btn-secondary btn-sm l14k"><i
                                        class="fa fa-reply"></i></a>
                                        <a data-href="{{ route('web.admin.message.detail.index') }}"
                                            data-id='{{ $item->id }}' class="btn btn-secondary btn-sm l14k"><i
                                                class="fa fa-eye"></i></a>
                                <a data-href="{{ route('web.admin.message.remove.do') }}"
