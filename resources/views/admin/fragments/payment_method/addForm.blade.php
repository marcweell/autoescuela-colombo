<div class="card">
    ...
    <div class="card-body">
        <h4 class="header-title">{{ __('Cadastro de Metodo de Pagamento') }}</h4>

        <form action="{{ route('web.admin.settings.payment_method.add.do') }}" class="form_ parent-load row" method="post">
