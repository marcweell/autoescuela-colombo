<div class="card">
    ...
    <div class="card-body">
        <h4 class="header-title">{{ __('Registro de Modulo') }}</h4>
        ...
        <form action="{{ route('web.admin.developer.module.add.do') }}" class="form_ parent-load row" method="post">
            ...
            <div class="col-md-6 mb-3">
                <label for="code" class="form-label">{{ __('Nombre') }}</label>
                <input type="text" name="code" id="code" class="form-control"
                    placeholder="{{ __('Ingrese codigo...') }}">
            </div>
            <div class="col-12 mb-3">
                <label for="">{{ __('Descripcion') }}</label>
