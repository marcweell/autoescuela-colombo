<div class="card">
    ...
    <div class="card-body">
        <div class="row mb-2">
            <div class="col-sm-5">
                <a data-href="{{ route('web.admin.developer.module.add.index') }}" data-id="-1" class="btn btn-primary mb-2 _link_"><i
                        class="mdi mdi-plus-circle me-2"></i> {{ __('Agregar Modulo') }}</a>
            </div>
            <div class="col-sm-7">
                        ...
                        <tr>
                            ...
                            <td class="table-action">
                                ...
                                <a data-href="{{ route('web.admin.developer.module.remove.do') }}"
                                    ...
                                    data-title="Eliminar Modulo"><i class="fa fa-trash"></i></a>
                            </td>
                        </tr>
                    @endfor
                </tbody>
