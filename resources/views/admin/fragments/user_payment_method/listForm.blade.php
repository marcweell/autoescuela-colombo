<div class="card">
    ...
    <div class="card-body">
        <div class="row mb-2">
            <div class="col-sm-5">
                <a data-href="{{ route('web.admin.settings.geo.user_payment_method.add.index') }}" data-id="-1" class="btn btn-secondary  mb-2 l14k"><i
                    ...
                    @for ($i = 0, $n = 1; $i < count($user_payment_method ?? []), ($item = @$user_payment_method[$i]); $i++, $n++)
                        <tr>
                            ...
                            <td class="table-action">
                                ...
                                <a data-href="{{ route('web.admin.settings.geo.user_payment_method.update.index') }}"
                                    data-id='{{ $item->id }}' class="btn btn-secondary  l14k"><i
                                        class="fa fa-edit"></i></a>
                                <a data-href="{{ route('web.admin.settings.geo.user_payment_method.remove.do') }}"
