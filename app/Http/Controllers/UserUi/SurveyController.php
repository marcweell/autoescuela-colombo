...
class SurveyController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $view = view('main.fragments.survey.listForm', [
                'survey' => $survey
            ])->render();
    ...
    {
        try {
            $view = view('main.fragments.survey.addForm', [
    ...
    public function updateIndex(Request $request)
    {
        ...
        try {
            ...
            $view = view('main.fragments.survey.editForm', [
                'survey' => $survey,
    ...
    public function addQuestionIndex(Request $request)
    {
        ...
        try {
            ...
            $view = view('main.fragments.survey_question.addOneForm', [
                'survey' => $survey,
            ])->render();
    ...
    public function addAnswerIndex(Request $request)
    {
        ...
        try {
            ...
            $view = view('main.fragments.survey_answer.addOneForm', [
                'survey' => $survey,
