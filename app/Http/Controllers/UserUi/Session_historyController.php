...
class Session_historyController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $view = view('user.fragments.session_history.listForm', [
    ...
    {
        try {
            $view = view('user.fragments.session_history.addForm', [
            ])->render();
    ...
    public function updateIndex(Request $request)
    {
        ...
        try {
            $session_history = $this->session_historyServiceQuery->findById($request->get('id'));
            $view = view('user.fragments.session_history.editForm', [
                'session_history'=>$session_history
            ])->render();
            return (new WebApi())->setSuccess()->print($view,'modal')->get();
        } catch (\Exception $e) {
