...
class RoleController extends Controller
{
    ...
    {
        try {
            $role = $this->roleServiceQuery->findAll();
            $view = view('user.fragments.role.listForm', [
                'role' => $role
            ])->render();
    ...
    {
        try {
            $view = view('user.fragments.role.addForm', [
            ])->render();
    ...
    public function updateIndex(Request $request)
    {
        ...
        try {
            $role = $this->roleServiceQuery->findById($request->get('id'));
            $view = view('user.fragments.role.editForm', [
                'role'=>$role
            ])->render();
            return (new WebApi())->setSuccess()->print($view,'modal')->get();
        } catch (\Exception $e) {
