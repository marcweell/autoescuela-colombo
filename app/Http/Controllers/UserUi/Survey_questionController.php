...
class Survey_questionController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $view = view('main.fragments.survey_question.listForm', [
    ...
    {
        try {
            $view = view('main.fragments.survey_question.addForm', [])->render();
    ...
    public function updateIndex(Request $request)
    {
        ...
        try {
            ...
            $view = view('main.fragments.survey_question.editForm', [
                'survey_question' => $survey_question
            ])->render();
            return (new WebApi())->setSuccess()->print($view, 'modal')->get();
        } catch (\Exception $e) {
