...
class Document_typeController extends Controller
{
    ...
    {
        try {
            $document_type = $this->document_typeServiceQuery->findAll();
            $view = view('user.fragments.document_type.listForm', [
    ...
    {
        try {
            $view = view('user.fragments.document_type.addForm', [
            ])->render();
    ...
    public function updateIndex(Request $request)
    {
        ...
        try {
            $document_type = $this->document_typeServiceQuery->findById($request->get('id'));
            $view = view('user.fragments.document_type.editForm', [
                'document_type'=>$document_type
            ])->render();
            return (new WebApi())->setSuccess()->print($view,'modal')->get();
        } catch (\Exception $e) {
