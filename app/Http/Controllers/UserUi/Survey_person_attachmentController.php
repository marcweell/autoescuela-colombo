...
class Survey_person_attachmentController extends Controller
{
    ...
    public function index(Request $request)
    {
        try {
            ...
            $view = view('main.fragments.survey_person_attachment.listForm', [
    ...
    {
        try {
            $view = view('main.fragments.survey_person_attachment.addForm', [
            ])->render();
    ...
    public function updateIndex(Request $request)
    {
        ...
        try {
            ...
            $view = view('main.fragments.survey_person_attachment.editForm', [
                'survey_person_attachment'=>$survey_person_attachment
            ])->render();
            return (new WebApi())->setSuccess()->print($view,'modal')->get();
        } catch (\Exception $e) {
