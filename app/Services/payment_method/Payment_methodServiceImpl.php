...
class Payment_methodServiceImpl implements IPayment_methodService
{
    private $insertFillables = ['name','code','type','classname','icon'];
    private $updateFillables = ['name','code','type','classname','icon'];
    ...
    public function add($data)
    {
        ...
        $payment_method = DB::table($this->table)->where('name', $data->name)->first();
        ...
        $payment_method = DB::table($this->table)->where('code', $data->code)->first();
    ...
    public function update($data)
    {
        ...
        $payment_method = DB::table($this->table)->where('id', $data->id)->first();
        if (empty($payment_method->id)) {
