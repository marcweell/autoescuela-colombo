...
class VillageServiceImpl implements IVillageService
{
    private $insertFillables = ['name', 'code', 'city_id'];
    private $updateFillables = ['name', 'code', 'city_id'];
    ...
    public function add($data)
    {
        ...
        $village = DB::table($this->table)->where('code', $data->code)->first();
    ...
    public function update($data)
    {
        ...
        $village = DB::table($this->table)->where('id', $data->id)->first();
        if (empty($village->id)) {
