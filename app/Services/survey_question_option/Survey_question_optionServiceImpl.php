...
class Survey_question_optionServiceImpl implements ISurvey_question_optionService
{
    ...
    public function __construct(){
        $this->serviceQuery = new Survey_question_optionServiceQueryImpl();
    }
    ...
    public function add($data)
    {
        ...
        $survey_question_option = $this->serviceQuery->findByCode($data->code);

        if (!empty($survey_question_option->id)) {
    ...
    public function update($data)
    {
        ...
        $survey_question_option = $this->serviceQuery->findById($data->id);
        if (empty($survey_question_option->id)) {
