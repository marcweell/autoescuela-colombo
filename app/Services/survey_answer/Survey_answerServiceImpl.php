...
class Survey_answerServiceImpl implements ISurvey_answerService
{
    private $insertFillables = ['code','survey_person_id','survey_question_id','answer','survey_question_option_id','correct'];
    private $updateFillables = ['code','survey_person_id','survey_question_id','answer','survey_question_option_id','correct'];
    private $table =  'survey_answer';
    private $serviceQuery;

    public function __construct(){
        $this->serviceQuery = new Survey_answerServiceQueryImpl();
    }
    ...
    public function add($data)
    {
        ...
        $survey_answer = $this->serviceQuery->findByCode($data->code);

        if (!empty($survey_answer->id)) {
    ...
    public function update($data)
    {
        ...
        $survey_answer = $this->serviceQuery->findById($data->id);
        if (empty($survey_answer->id)) {
