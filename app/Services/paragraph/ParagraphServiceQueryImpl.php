...
class ParagraphServiceQueryImpl implements IParagraphServiceQuery
{
...
;    }
    ...
    {
        $paragraph = $this->query->where($this->table . '.id', $id)->first();
        return $paragraph;
    }
    public function findByCode($id)
    {
        $paragraph = $this->query->where($this->table . '.code', $id)->first();
        return $paragraph;
    } 
}
