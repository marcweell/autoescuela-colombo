...
class Marital_statusServiceImpl implements IMarital_statusService
{
    private $insertFillables = ['name','code'];
    private $updateFillables = ['name','code'];
    private $table =  'marital_status';
    ...
    public function add($data)
    {
        ...
        $marital_status = DB::table($this->table)->where('name', $data->name)->first();
        ...
        $marital_status = DB::table($this->table)->where('code', $data->code)->first();
    ...
    public function update($data)
    {
        ...
        $marital_status = DB::table($this->table)->where('id', $data->id)->first();
        if (empty($marital_status->id)) {
