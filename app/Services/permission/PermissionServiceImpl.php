...
{
    private $insertFillables = ['name','code','description','module_id'];
    private $updateFillables = ['name','code','description','module_id'];
    ...
    public function add($data)
    {
        ...
        $permission = DB::table($this->table)->where('name', $data->name)->first();
        ...
        $permission = DB::table($this->table)->where('code', $data->code)->first();
    ...
    public function update($data)
    {
        ...
        $permission = DB::table($this->table)->where('id', $data->id)->first();
        if (empty($permission->id)) {
