...
class LanguageServiceImpl implements ILanguageService
{
    ...
    public function add($data)
    {
        ...
        $language = DB::table($this->table)->where('name', $data->name)->first();
        ...
        $language = DB::table($this->table)->where('code', $data->code)->first();
    ...
    public function update($data)
    {
        ...
        $language = DB::table($this->table)->where('id', $data->id)->first();
        if (empty($language->id)) {
