...
class CityServiceImpl implements ICityService
{
    private $insertFillables = ['name','code','country_id'];
    ...
    public function add($data)
    {
        ...
        $city = DB::table($this->table)->where('name', $data->name)->first();
        ...
        $city = DB::table($this->table)->where('code', $data->code)->first();
    ...
    public function update($data)
    {
        ...
        $city = DB::table($this->table)->where('id', $data->id)->first();
        if (empty($city->id)) {
