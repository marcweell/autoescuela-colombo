...
namespace App\Services\survey_category;
...
class Survey_categoryServiceImpl implements ISurvey_categoryService
{
    ...
    public function add($data)
    {
        ...
        $survey_category = DB::table($this->table)->where('name', $data->name)->first();
    ...
    public function update($data)
    {
        ...
        $survey_category = DB::table($this->table)->where('id', $data->id)->first();
        if (empty($survey_category->id)) {
