...
class Person_data_optionServiceImpl implements IPerson_data_optionService
{
    private $insertFillables = ['name', 'code'];
    private $updateFillables = ['name', 'code'];
    private $table =  'person_data_option';
    private $serviceQuery;

    public function __construct(){
        $this->serviceQuery = new Person_data_optionServiceQueryImpl();
    }
    ...
    public function add($data)
    {
        ...
        $person_data_option = $this->serviceQuery->findByCode($data->code);

        if (!empty($person_data_option->id)) {
    ...
    public function update($data)
    {
        ...
        $person_data_option = $this->serviceQuery->findById($data->id);
        if (empty($person_data_option->id)) {
