...
class GenderServiceImpl implements IGenderService
{
    ...
    public function add($data)
    {
        ...
        $gender = DB::table($this->table)->where('name', $data->name)->first();
        ...
        $gender = DB::table($this->table)->where('code', $data->code)->first();
    ...
    public function update($data)
    {
        ...
        $gender = DB::table($this->table)->where('id', $data->id)->first();
        if (empty($gender->id)) {
